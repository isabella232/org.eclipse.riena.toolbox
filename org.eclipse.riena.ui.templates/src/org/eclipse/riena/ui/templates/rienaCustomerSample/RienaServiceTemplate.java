...
public class RienaServiceTemplate extends RienaTemplateSection {
	...
	public String getSectionId() {
		return "rienaCustomerSampleService"; //$NON-NLS-1$
	}
	...
	public IPluginReference[] getDependencies(String schemaVersion) {
		return getServiceDependencies(schemaVersion);
	}
