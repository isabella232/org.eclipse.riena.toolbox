...
public class RienaCommonTemplate extends RienaTemplateSection {
	...
	public String getSectionId() {
		return "rienaCustomerSampleCommon"; //$NON-NLS-1$
	}
	...
	protected void updateModel(IProgressMonitor monitor) throws CoreException {
		...
		setManifestHeader("Export-Package", getStringOption(KEY_PACKAGE_NAME));
		setManifestHeader("Eclipse-RegisterBuddy",
	...
	public IPluginReference[] getDependencies(String schemaVersion) {
		return getCommonDependencies(schemaVersion);
	}
