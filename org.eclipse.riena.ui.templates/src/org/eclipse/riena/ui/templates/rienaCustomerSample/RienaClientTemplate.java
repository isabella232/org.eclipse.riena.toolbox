...
public class RienaClientTemplate extends RienaTemplateSection {
	...
	public String getSectionId() {
		return "rienaCustomerSampleClient"; //$NON-NLS-1$
	}
	...
	public IPluginReference[] getDependencies(String schemaVersion) {
		return getHeadlessClientDependencies(schemaVersion);
	}
